...
## 🌐 App đã triển khai (dùng ngay, không cần cài gì)

**https://duongvh86vn.github.io/stop-motion-pipeline-studio/**

- Là PWA: mở bằng Edge/Chrome → biểu tượng **Cài đặt ứng dụng** trên thanh địa chỉ
  → chạy như app desktop, hoạt động cả khi offline.
- Dữ liệu dự án lưu ngay trong trình duyệt của bạn (không gửi đi đâu).
- Mã nguồn: https://github.com/duongvh86vn/stop-motion-pipeline-studio

## Chạy app trên máy (local)

Cách 1 — nhấp đúp file **`CHAY-APP.bat`** (tự mở server + trình duyệt).
